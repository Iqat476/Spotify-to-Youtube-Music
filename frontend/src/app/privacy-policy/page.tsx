...
export default function PrivacyPolicy() {
	return (
		<div className="pl-3 pr-3 mt-12 [&_h2]:py-2 [&_h2]:pl-1 [&_h3]:pl-2 [&_h4]:pl-3 md:[&_h2]:pl-4 md:[&_h3]:pl-6 md:[&_h4]:pl-8">
			...
			<hr className="border-1 border-dark dark:border-light pb-3" />

			<h1>Privacy Policy</h1>

			<h3 className="pt-2 pb-5 pl-2">Last updated: February 11, 2025</h3>
			...
			<div>
				...
				<h4>
					...
					refers to Spotify to Youtube Music.
				</h4>
				...
				<h4>Country refers to: United Arab Emirates</h4>
				...
				<h4>
					Website refers to Spotify to Youtube Music, accessible from
