...
export default function TemrsOfServer() {
	return (
		<div className="pl-3 pr-3 mt-12 [&_h2]:py-2 [&_h2]:pl-1 [&_h3]:pl-2 [&_h4]:pl-3 md:[&_h2]:pl-4 md:[&_h3]:pl-6 md:[&_h4]:pl-8">
			<Link
				href="/"
				className="pb-3 flex items-center justify-start gap-1 hover:text-secondary-light hover:[&_svg]:fill-secondary-light dark:hover:text-primary-light dark:hover:[&_svg]:fill-primary-light"
			>
				<svg
					aria-hidden="true"
			...
			<hr className="border-1 border-dark dark:border-light pb-6" />

			<h1 id="terms-and-conditions">TERMS AND CONDITIONS</h1>
			<h3>Last updated February 11, 2025</h3>
			<h2 id="agreement-to-our-legal-terms">AGREEMENT TO OUR LEGAL TERMS</h2>
			<h4>
				We are Spotify to Youtube Music (&#39;Company&#39;, &#39;we&#39;,
				&#39;us&#39;, or &#39;our&#39;).
			</h4>
			<h4>
				We operate the website{" "}
				<a href="https://convert-playlists.taqi.dev/">
					https://convert-playlists.taqi.dev/
				</a>{" "}
			...
			<h4>
				...
				Spotify to Youtube Music, concerning your access to and use of the
			...
			<h2 id="1-our-services">1. OUR SERVICES</h2>
			<h4>
			...
			<h2 id="2-intellectual-property-rights">
			...
			<h3 id="your-submissions">Your submissions</h3>
			<h4>
			...
			<h4>
				...
				read and agree with our &#39;PROHIBITED ACTIVITIES&#39; and will not
				...
				original to you or that you have the necessary rights and licences to
			...
			<h2 id="3-user-representations">3. USER REPRESENTATIONS</h2>
			<h4>
			...
			<h2 id="4-user-registration">4. USER REGISTRATION</h2>
			<h4>
			...
			<h4>
				...
				collection mechanisms&#39; or &#39;pcms&#39;). Interfere with, disrupt,
				or create an undue burden on the Services or the networks or services
			...
			<h2 id="6-user-generated-contributions">
			...
			<h4>
				...
				party. You are the creator and owner of or have the necessary licences,
			...
			<h2 id="7-contribution-licence">7. CONTRIBUTION LICENCE</h2>
			<h4>
			...
			<h2 id="8-social-media">8. SOCIAL MEDIA</h2>
			<h4>
			...
			<h2 id="9-services-management">9. SERVICES MANAGEMENT</h2>
			<h4>
			...
			<h2 id="10-privacy-policy">10. PRIVACY POLICY</h2>
			<h4>
				We care about data privacy and security. Please review our Privacy
				Policy:{" "}
				<Link href="/privacy-policy" className="underline">
					https://convert-playlists.taqi.dev/privacy-policy
				</Link>
				...
				Services are hosted in the United Arab Emirates. If you access the
				...
				differ from applicable laws in the United Arab Emirates, then through
				your continued use of the Services, you are transferring your data to
				the United Arab Emirates, and you expressly consent to have your data
				transferred to and processed in the United Arab Emirates.
			</h4>
			<h2 id="11-term-and-termination">11. TERM AND TERMINATION</h2>
			<h4>
			...
			<h2 id="12-modifications-and-interruptions">
			...
			<h4>
				...
				the United Arab Emirates. Spotify to Youtube Music and yourself
			...
			<h2 id="14-dispute-resolution">14. DISPUTE RESOLUTION</h2>
			<h4>
				...
				Party. Binding Arbitration Any dispute arising out of or in connection
				...
				be one (1). The seat, or legal place, or arbitration shall be Abu Dhabi,
				United Arab Emirates. The language of the proceedings shall be English.
				The governing law of these Legal Terms shall be substantive law of the
				United Arab Emirates. Restrictions The Parties agree that any
			...
			<h2 id="15-corrections">15. CORRECTIONS</h2>
			<h4>
			...
			<h2 id="16-disclaimer">16. DISCLAIMER</h2>
			<h4>
			...
			<h2 id="17-limitations-of-liability">17. LIMITATIONS OF LIABILITY</h2>
			<h4>
			...
			<h2 id="18-indemnification">18. INDEMNIFICATION</h2>
			<h4>
			...
			<h2 id="19-user-data">19. USER DATA</h2>
			<h4>
			...
			<h2 id="20-electronic-communications-transactions-and-signatures">
			...
			<h2 id="21-california-users-and-residents">
			...
			<h2 id="22-miscellaneous">22. MISCELLANEOUS</h2>
			<h4>
